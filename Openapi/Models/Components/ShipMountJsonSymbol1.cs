...
namespace Openapi.Models.Components
{
    ...
    /// Symbo of this mount.
    /// </summary>
    public enum ShipMountJsonSymbol1
    {
    ...
    public static class ShipMountJsonSymbol1Extension
    {
        public static string Value(this ShipMountJsonSymbol1 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ShipMountJsonSymbol1 ToEnum(this string value)
        {
            foreach(var field in typeof(ShipMountJsonSymbol1).GetFields())
            {
                ...
                {
                    return (ShipMountJsonSymbol1)field.GetValue(null);
                }
            }

            throw new Exception($"Unknown value {value} for enum ShipMountJsonSymbol1");
        }
    }
