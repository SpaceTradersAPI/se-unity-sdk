...
namespace Openapi.Models.Components
{
    ...
    public static class TradeSymbolJsonExtension
    {
        public static string Value(this TradeSymbolJson value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static TradeSymbolJson ToEnum(this string value)
        {
            foreach(var field in typeof(TradeSymbolJson).GetFields())
            {
                ...
                {
                    return (TradeSymbolJson)field.GetValue(null);
                }
            }

            throw new Exception($"Unknown value {value} for enum TradeSymbolJson");
        }
    }
